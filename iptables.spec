...
%build
# >> build pre
CFLAGS="$RPM_OPT_FLAGS -fno-strict-aliasing" ./configure --enable-devel --enable-libipq --prefix=/ --libexecdir=/%{_lib} --mandir=%{_mandir} --includedir=%{_includedir} --with-kernel=/usr --with-kbuild=/usr --with-ksource=/usr
